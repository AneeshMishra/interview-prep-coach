...
## Role Focus
- Test DOCX parsing, schema validation, ingestion, persistence, embeddings, Qdrant search and filters.
- Use deterministic mocked LLMs in CI.
- Verify provenance and persistence across application restart.
